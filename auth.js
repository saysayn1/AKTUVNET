...
function toggleMode(e) {
    ...
    if (isLoginMode) {
        ...
        document.querySelector('.logo h1').textContent = 'Welcome back to AKTUVNET!';
        document.querySelector('.logo p').textContent = "Ready to game? Let's go!";
    } else {
        ...
        document.querySelector('.logo h1').textContent = 'Завести аккаунт';
        document.querySelector('.logo p').textContent = 'Добро пожаловать в AKTUVNET!';
    }
